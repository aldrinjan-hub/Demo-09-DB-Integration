...
// "isDone": true } | { "name": "Task 1 Updated" } | { "isDone":
// true }
app.put('/tasks/:id', async (req, res) => 
{
    const id = req.params.id;
    const taskUpdate = await sql`UPDATE Tasks SET Name = ${(req.body.name != undefined ? req.body.name : task.name)}, IsDone = ${(req.body.isDone != undefined ? req.body.isDone :task.isDone)} WHERE Id = ${id};`;
